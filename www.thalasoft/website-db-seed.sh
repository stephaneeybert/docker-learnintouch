...
sed -e "s/DB_PASSWORD/$WWW_THALASOFT_DB_PASSWORD/g" < /usr/bin/learnintouch/www/thalasoft.com/db-database.sql | /usr/bin/mariadb/install/bin/mysql --protocol=tcp -h mysql -P 3306 -u root -v
